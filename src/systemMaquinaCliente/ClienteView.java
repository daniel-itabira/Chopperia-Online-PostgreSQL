...
public class ClienteView extends JFrame {
	...
	public ClienteView() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(lbCartaoCliente.getText().equals("----")) {
					
				}else {
					HistoricoCliente historico = new HistoricoCliente(Integer.parseInt(lbCartaoCliente.getText()));
					historico.setVisible(true);
				}
				
			}
		});
		btnNewButton.setBounds(321, 136, 155, 34);
